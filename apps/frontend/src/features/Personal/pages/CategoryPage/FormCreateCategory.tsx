      ...
      <div className="form-main">
        ...
        <div className="item-form">
          ...
          <div
            ...
            style={!activeDrop2 ? { display: 'none' } : { display: 'block' }}
          >
            <div>
        ...
        <div className="item-form">
          ...
          <div
            className="drop-table"
            style={!activeDrop3 ? { display: 'none' } : { display: 'block' }}
          >
            <div>
              <div className="title-drop">Nguồn báo :</div>
              {data.map((e, index) => (
        ...
        <div className="group-btn">
          <button
            ...
            onClick={() => console.log(setActiveFormCreate)}
          >
            Hủy bỏ
          </button>
